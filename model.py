...
class MyModel(nn.Module):
    def __init__(self,freeze_bert=False,model_name="hfl/chinese-xlnet-base",bert_hidden_size=768,num_class=2,lstm_hidden_dim=384,n_layers=2,bidirectional=True):
        ...
        self.bert=AutoModelForSequenceClassification.from_pretrained(model_name,num_labels=num_class)
        if freeze_bert:
    ...
    def forward(self,input_ids,attn_masks,token_type_ids):
        output=self.bert(input_ids,token_type_ids=token_type_ids,attention_mask=attn_masks)[0]
